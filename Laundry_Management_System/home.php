...
<section class="home">
   <div class="status-container">
      ...
      <center>
      <div><h3><I>Email: <?=$emailFromDB?></I></h3></div>
      <div><h3>Status: <?=$statusFromDB?><br><I>Order Date:<?=$dateFromDB?></h3></div>
      </center>
   </div>
...
<section class="footer">
   ...
   <div class="box">
      ...
      <div class="box">
         <h3>Contact Us</h3>
         <a href="contact.php"> <i class="fas fa-phone"></i> Naveen Chandar</a>
         <a> <i class="fas fa-envelope"></i> naveenchandar@gmail.com </a>
         <a> <i class="fas fa-map"></i> RVSCAS,Sulur,Coimbatore</a>
      </div>
